...
import io.github.daxigua2333.cmagic_clue.guis.widget.ScrollableDropdownWidget;
...
public class AttachedClueEditorScreen extends ClueBookScreenLayout implements ItemClueHolder {
    ...
    public AttachedClueEditorScreen(
        ...
        super(Component.translatable(CMagicClue.MODID + "screen.editor"));
...
//            PacketDistributor.sendToServer(new ScreenCreateDefaultCluePayload(tab.getSelected(), location));
        ...
        tab = new ScrollableDropdownWidget<>(
                ...
                type -> {
                    ...
                    return Component.translatable(CMagicClue.MODID + ".enum." + type.toString());
                },
