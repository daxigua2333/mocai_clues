...
@OnlyIn(Dist.CLIENT)
public class ClueInventoryScreen extends AbstractContainerScreen<ClueInventoryMenu> {
    private static final ResourceLocation CONTAINER_BACKGROUND = ResourceLocation.withDefaultNamespace("textures/gui/container/generic_54.png");
    private final int containerRows;

    public ClueInventoryScreen(ClueInventoryMenu menu, Inventory inv, Component title) {
        super(menu, inv, title);
        this.containerRows = 3;   // TODO: config rows
