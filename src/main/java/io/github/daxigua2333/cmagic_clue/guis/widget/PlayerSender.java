...
import io.github.daxigua2333.cmagic_clue.integration.CmagicCompat;
import io.github.daxigua2333.cmagic_clue.integration.DependencyManager;
...
public class PlayerSender extends AbstractContainerWidget {
    ...
    private static final Component PREFIX = Component.translatable(CMagicClue.MODID + ".screen.share_with");
    ...
    public PlayerSender(
        ...
        button = Button.builder(Component.translatable(CMagicClue.MODID + ".screen.share"),
                        btn -> onSend.accept(selected))
                .bounds(x + width - BUTTON_WIDTH, y, BUTTON_WIDTH, height)
                .build();

        sendToAllButton = Button.builder(Component.translatable(CMagicClue.MODID + ".screen.share_with_all"),
