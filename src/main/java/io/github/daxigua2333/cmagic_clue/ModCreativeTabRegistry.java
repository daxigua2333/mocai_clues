...
public class ModCreativeTabRegistry {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, CMagicClue.MODID);
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CLUE_ITEMS = CREATIVE_MODE_TABS.register("clue_items", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup." + CMagicClue.MODID)) //The language key for the title of your CreativeModeTab
