...
//
//
//////        List<String> options = List.of("Easy", "Normal", "Hard");
////        List<String> options = new ArrayList<>(List.of("Easy", "Normal", "Hard"));
////
////        CycleButton<String> difficultyDropdown = CycleButton
////                .builder((String value) -> Component.literal(value))
////                .withValues(options)
////                .withInitialValue("Normal")
////                .create(
////                        this.width / 2 - 75, // x
////                        this.height / 2 - 10, // y
////                        150,                  // width
...
////                            // handle value change
////                            options.add("1");
////                            System.out.println("Difficulty set to " + value);
////                        });
////
////        this.addRenderableWidget(difficultyDropdown);
//
...
//                Component::literal,
//                value -> {
//                    System.out.println("Selected color: " + value);
//                }
//        );
...
//     * Extends ObjectSelectionList.Entry and implements render() + narration.
//     */
