...
public final class TickHook {
    ...
    public static void onClientTick(ClientTickEvent.Post event) {
        ...
        List<ClueObject> data = DataManager.Client.retrieveByNearbyLoadedChunks(level, mc.player.chunkPosition(), Math.min(CHUNK_RADIUS, Minecraft.getInstance().options.renderDistance().get())).objects();
